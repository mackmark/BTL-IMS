...
$query1 = "SELECT sd.DateCreated, s.SheetNo, s.DateCreated as 'prodDate', cb.CurringBooth ";
...
$query1 .= "WHERE s.SheetID = '".$cat_id."' order by sd.DateCreated ASC LIMIT 1 ";
$resultQuery1 = mysqli_query($con, $query1);
$rowQuery1 = mysqli_fetch_array($resultQuery1);
...
$pdf->Cell(20,5,date('d-M-y', strtotime($rowQuery1['prodDate'])),0,0, 'L');
$pdf->Cell(10,5,'',0,0, 'C');
$pdf->SetFont('Helvetica','',8);
$pdf->Cell(20,5,'Sheet No.:',0,0, 'R');
$pdf->SetFont('Helvetica','B',9);
$pdf->Cell(22,5,$rowQuery1['SheetNo'],0,0, 'L');
$pdf->Cell(9,5,'',0,1, 'L');
...
$pdf->SetFont('Helvetica','B',9);
$pdf->Cell(20,5,$rowQuery1['CurringBooth'],0,1, 'L');

$pdf->SetXY(0,31);

$pdf->SetFont('Helvetica','B',9);
$pdf->Cell(2,6,'',0,0, 'C');
$pdf->Cell(7,6,'SN',1,0, 'C');
$pdf->Cell(20,6,'Line',1,0, 'C');
$pdf->Cell(12,6,'Shift',1,0, 'C');
$pdf->Cell(15,6,'Rack No.',1,0, 'C');
$pdf->Cell(23,6,'Plate Type',1,0, 'C');
$pdf->Cell(20,6,'Oxide Type',1,0, 'C');
$pdf->Cell(11,6,'Result',1,0, 'C');
$pdf->Cell(2,6,'',0,1, 'C');
...
$query2 .="WHERE sd.SheetID = '".$cat_id."' and sd.IsActive = 1 and sd.IsDeleted = 0 ";
...
while($rowQuery2 = mysqli_fetch_array($resultQuery2)){
    ...
    $pdf->Cell(2,6,'',0,0, 'C');
    $pdf->Cell(7,6,$SN,1,0, 'C');
    $pdf->Cell(20,6,$rowQuery2['Line'],1,0, 'C');
    $pdf->Cell(12,6,$rowQuery2['Shift'],1,0, 'C');
    $pdf->Cell(15,6,$rowQuery2['RackNo'],1,0, 'C');
    $pdf->Cell(23,6,$rowQuery2['PlateType'],1,0, 'C');
    $pdf->Cell(20,6,$rowQuery2['OxideType'],1,0, 'C');
    $pdf->Cell(11,6,'',1,0, 'C');
    $pdf->Cell(2,6,'',0,1, 'C');
...
$file = "../../system_file/Sheet".$cat_id."print.pdf";
$pdf->Output('F', $file);
