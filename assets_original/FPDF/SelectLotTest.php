...
$query .= "WHERE SheetDetailID = (SELECT SheetDetailID FROM sheetdetail_tbl WHERE SheetDetailID = '".$cat_id."') ";
...
$query2 = "SELECT LotNumber FROM sheetdetail_tbl WHERE SheetDetailID = '".$cat_id."' ";
$result2 = mysqli_query($con, $query2);
confirmQuery($result2);
$rowLot = mysqli_fetch_array($result2);

$pdf->SetFont('Helvetica','B',10);
$pdf->SetXY(0,30);
$pdf->Cell(40,7,'',0,0, 'L');
$pdf->Cell(72,7,'',0,0, 'C');
$pdf->Cell(40,7,$rowLot['LotNumber'],0,1, 'C');
...
$queryDetail .= "WHERE sd.SheetDetailID = '".$cat_id."' ";
