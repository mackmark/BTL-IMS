<?php
    ...
    $samplesID = isset($_POST['testSampleID']) ? $_POST['testSampleID'] : 0;
    ...
    where samples.TestSamplesID = ".$samplesID." ";
    ...
    $file = "../../SamplesFileSystem/".$samplesID.".pdf";
    $pdf->Output('F', $file);

    // $pdf->Output('I', $file);
    // $pdf->Output();

    echo json_encode($samplesID);
?>