                ...
                <div class="page-content">
                    <section class="row">
                        <div class="divider divider-center">
                            <div class="divider-text text-primary"><h6>Reprinting Samples Label</h6></div>
                            <div class="card">
                                <div class="card-body print-container" style="height:73vh;overflow-y:scroll;">
                                    <div class="row reprinting-container">
                                    </div>
                                </div>
                                <div class="container">
                                    <div class="row">
...
<script>
    ...
    function checkForprint(){
        $.ajax({
            ...
            data: {
                action:'fetchAvailRePrint'
            },
            dataType: "JSON",
            success: function (data) {
                $('.reprinting-container').html(data)
            }
        });
    }
